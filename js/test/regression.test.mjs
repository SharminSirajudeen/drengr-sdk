...
test('opaque vendor secrets under a benign key are scrubbed by value', () => {
  const b = redactBody(JSON.stringify({
    data: 'sk_live_abcdef0123456789ABCDEF',
    note: 'key is AKIAIOSFODNN7EXAMPLE here',
    gh: 'ghp_' + 'a'.repeat(36),
    goog: 'AIza' + 'b'.repeat(35),
    orderId: 'order_12345', amount: 25,
  }));
  ...
  assert.match(b, /"orderId":"order_12345"/);
